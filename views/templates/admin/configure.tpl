	...
	<div class="row">
		<div class="sidebar navigation col-md-2">
			<nav class="list-group categorieList">
				...
				<a class="list-group-item{$orders_tab}" data-id="orders" href="#orders"><i class="icon-ok-sign"></i> {l s='Orders' mod='bdroppy'}</a>
		...
		<div class="panel content-wrap form-horizontal col-lg-10">
			...
			<form action="" method="post">
				<fieldset id="orders" class="{$orders_form}">
					<h3 class="tab"> <i class="icon-ok-sign"></i>&nbsp;{l s='Orders' mod='bdroppy'}</h3>
					<div class="form-group">
						<label class="control-label col-lg-3" for="simple_product">{l s='Catalog' mod='bdroppy'}:</label>
						<div class="col-lg-7">
							{$ordersHtml}
